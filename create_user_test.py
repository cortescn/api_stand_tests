...
def positive_assert(first_name):
    ...
    print(users_table_response.text.count)
...
# Prueba 4. Error
# El párametro "firstName" contiene 16 carácteres
def test_create_user_16_letter_in_first_name_get_error_response():
    negative_assert_symbol("Аааааааааааааааа")

#Prueba 7. Creación de una nueva usuaria o usuario
...
# Prueba 10. Error
# El parámetro "firstName" contiene
